...
namespace dragdrop
{
    public partial class OverlayFormClauses : Form
    {
        public OverlayFormClauses()
        {
            InitializeComponent();
        }
        ...
        private void textBox2_DragDrop(object sender, DragEventArgs e)
        {
           string text = e.Data.GetData(DataFormats.Text).ToString();
            this.Hide();
            Globals.ThisAddIn.OnDropOccurredclauses(e.X, e.Y, e.Data.GetData(DataFormats.Text).ToString());            
        }
