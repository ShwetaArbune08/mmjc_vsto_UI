...
namespace dragdrop
{
    ...
    /// User control 
    /// </summary>
    public partial class ClausesListUserControl : UserControl
    {
      
          public ClausesListUserControl()
        {
          InitializeComponent();
        }
        public ClausesListUserControl(List<Attributes> lstattributesobj)
        {
            InitializeComponent();
            foreach (var item in lstattributesobj)
            {
        ...
        public ClausesListUserControl(List<Clauses> lstattributesobj)
        {
            InitializeComponent();
            foreach (var item in lstattributesobj)
            {
        ...
        static OverlayFormClauses form;
        /// <summary>
        ...
        private void OverlayForm()
        {
            if (form == null)
            {
                ...
                Globals.ThisAddIn.OverlayFormClauses = form;
                form.Show();
            }
            else
            {
